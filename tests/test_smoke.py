...
from energy_log.cli import main
from energy_log.models import Note, ProjectState, Task
from energy_log.cli import demo_state
from energy_log.storage import load_state, save_state
from energy_log.models import generate_short_id
from energy_log.validation import normalize_tags, require_text, validate_task_status
from energy_log.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
